...
const InvoicePage = ({ data, pdfMode, onChange }) => {
  ...
  return (
    <Document>
      <Page className="relative bg-white px-[30px] py-10 shadow-md">
        ...
        {/* BIll TO */}
        <View className="mt-[40px] flex" pdfMode={pdfMode}>
          ...
          <View className="w-45" pdfMode={pdfMode}>
            <View className="mb-5 flex" pdfMode={pdfMode}>
        ...
        {/* Table Header */}
        <View className="mt-[30px] flex bg-dark" pdfMode={pdfMode}>
        ...
        {invoice.productLines.map((productLine, i) => {
          return pdfMode && productLine.description === "" ? (
            ...
            <View key={i} className="row flex" pdfMode={pdfMode}>
              <View className="p-4-8 w-48 pb-10" pdfMode={pdfMode}>
              ...
              <View className="w-17 p-4-8 pb-10" pdfMode={pdfMode}>
                <EditableInput className="right dark" value={productLine.quantity} onChange={(value) => handleProductLineChange(i, "quantity", value)} pdfMode={pdfMode} />
              </View>
              <View className="w-17 p-4-8 pb-10" pdfMode={pdfMode}>
                <EditableInput className="right dark" value={productLine.rate} onChange={(value) => handleProductLineChange(i, "rate", value)} pdfMode={pdfMode} />
              </View>
        ...
        {/* Table footer and add line button */}
        <View className="flex" pdfMode={pdfMode}>
          ...
          <View className="w-50 mt-20" pdfMode={pdfMode}>
            ...
            <View className="bg-gray flex p-5" pdfMode={pdfMode}>
              ...
              <View className="w-50 flex p-5" pdfMode={pdfMode}>
                <EditableInput className="bold right ml-30 dark" value={invoice.currency} onChange={(value) => handleChange("currency", value)} pdfMode={pdfMode} />
